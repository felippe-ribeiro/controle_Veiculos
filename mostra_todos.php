...
if (empty($termo)):
	...
	$conexao = conexao::getInstance();
	$sql = 'SELECT id, matricula, tipo, situacao, nome, identidade, placa, veiculo, cidade, uf, empresa, datacadastro, foto, resp_cad FROM tb_cadastro WHERE nome LIKE :nome OR matricula LIKE :matricula OR datacadastro LIKE :datacadastro';
